...
/* Window class names */
static const wchar_t wszWindowClassMainWindow[] = L"PolarisMainWindow";
static const wchar_t wszWindowClassRenderingPanel[] = L"PolarisRenderingPanel";
static const wchar_t wszWindowClassEditorPanel[] = L"PolarisEditorPanel";
...
static BOOL InitApp(HINSTANCE hInstance, int nCmdShow)
{
	...
	conf_window_title = strdup("Polaris Engine Pro");
...
static BOOL CreateProjectFromTemplate(const wchar_t *pszTemplate)
{
	...
	while (1)
	{
		...
		ofn.lpstrFilter = bEnglish ?
			L"Polaris Engine Project Files\0*.polaris;\0Old Project Files\0*.polaris2project\0\0" :
			L"Polaris Engine プロジェクトファイル\0*.polaris\0旧プロジェクトファイル\0*.polaris2project\0\0";
