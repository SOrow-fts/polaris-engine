 ...
 *  - 2017-08-14 Created.
 *  - 2017-10-31 Added SE.
 *  - 2019-09-17 Added @news support. (for Matsuno-san)
 *  - 2022-06-17 Added @choose. Incorporated @news configs to @switch ones.
 *  - 2023-06-26 Refactoring.
 *  - 2023-08-26 Added a config conf_msgbox_show_on_choose.
 *  - 2023-09-12 Commonize the message drawing routines.
 *  - 2024-03-09 Increased the maximum option from 8 to 10.
