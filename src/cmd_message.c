 ...
 *  - 2016-06-24 Created.
 *  - 2017-01-30 Added "\n".
 *  - 2017-04-13 Added English word wrapping.
 *  - 2021-06-15 Added @setsave.
 *  - 2021-07-29 Added buttons.
 *  - 2021-07-30 Added auto mode.
 *  - 2021-07-31 Added skip mode.
 *  - 2022-06-06 Added debugger support.
 *  - 2022-07-19 Added system menu.
 *  - 2022-07-28 Added config.
 *  - 2022-08-08 Moved from special save/load/history screens to simple GUIs.
 *  - 2023-06-19 Refactoring.
 *  - 2023-08-14 Added color and size control.
 *  - 2023-08-19 Added inline wait.
