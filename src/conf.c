 ...
 * [Changes]
 *  - 2016-06-25 Created.
 *  - 2017-08-14 Added @switch support.
 *  - 2019-09-17 Added @news support.
...
static struct rule {
	...
	{"var.name0", 's', &conf_var_name[0], OPTIONAL, SAVE},
	{"var.name1", 's', &conf_var_name[1], OPTIONAL, SAVE},
	{"var.name2", 's', &conf_var_name[2], OPTIONAL, SAVE},
	{"var.name3", 's', &conf_var_name[3], OPTIONAL, SAVE},
	{"var.name4", 's', &conf_var_name[4], OPTIONAL, SAVE},
	{"var.name5", 's', &conf_var_name[5], OPTIONAL, SAVE},
	{"var.name6", 's', &conf_var_name[6], OPTIONAL, SAVE},
	{"var.name7", 's', &conf_var_name[7], OPTIONAL, SAVE},
	{"var.name8", 's', &conf_var_name[8], OPTIONAL, SAVE},
	{"var.name9", 's', &conf_var_name[9], OPTIONAL, SAVE},
	{"var.name10", 's', &conf_var_name[10], OPTIONAL, NOSAVE},
	{"var.name11", 's', &conf_var_name[11], OPTIONAL, NOSAVE},
	{"var.name12", 's', &conf_var_name[12], OPTIONAL, NOSAVE},
	{"var.name13", 's', &conf_var_name[13], OPTIONAL, NOSAVE},
	{"var.name14", 's', &conf_var_name[14], OPTIONAL, NOSAVE},
	{"var.name15", 's', &conf_var_name[15], OPTIONAL, NOSAVE},
	{"var.name16", 's', &conf_var_name[16], OPTIONAL, NOSAVE},
	{"var.name17", 's', &conf_var_name[17], OPTIONAL, NOSAVE},
	{"var.name18", 's', &conf_var_name[18], OPTIONAL, NOSAVE},
	{"var.name19", 's', &conf_var_name[19], OPTIONAL, NOSAVE},
	{"var.name20", 's', &conf_var_name[20], OPTIONAL, NOSAVE},
	{"var.name21", 's', &conf_var_name[21], OPTIONAL, NOSAVE},
	{"var.name22", 's', &conf_var_name[22], OPTIONAL, NOSAVE},
	{"var.name23", 's', &conf_var_name[23], OPTIONAL, NOSAVE},
	{"var.name24", 's', &conf_var_name[24], OPTIONAL, NOSAVE},
	{"var.name25", 's', &conf_var_name[25], OPTIONAL, NOSAVE},
	{"var.name26", 's', &conf_var_name[26], OPTIONAL, NOSAVE},
	{"var.name27", 's', &conf_var_name[27], OPTIONAL, NOSAVE},
	{"var.name28", 's', &conf_var_name[28], OPTIONAL, NOSAVE},
	{"var.name29", 's', &conf_var_name[29], OPTIONAL, NOSAVE},
	{"var.name30", 's', &conf_var_name[30], OPTIONAL, NOSAVE},
	{"var.name31", 's', &conf_var_name[31], OPTIONAL, NOSAVE},
	{"var.name32", 's', &conf_var_name[32], OPTIONAL, NOSAVE},
	{"var.name33", 's', &conf_var_name[33], OPTIONAL, NOSAVE},
	{"var.name34", 's', &conf_var_name[34], OPTIONAL, NOSAVE},
	{"var.name35", 's', &conf_var_name[35], OPTIONAL, NOSAVE},
	{"var.name36", 's', &conf_var_name[36], OPTIONAL, NOSAVE},
	{"var.name37", 's', &conf_var_name[37], OPTIONAL, NOSAVE},
	{"var.name38", 's', &conf_var_name[38], OPTIONAL, NOSAVE},
	{"var.name39", 's', &conf_var_name[39], OPTIONAL, NOSAVE},
	{"var.name40", 's', &conf_var_name[40], OPTIONAL, NOSAVE},
	{"var.name41", 's', &conf_var_name[41], OPTIONAL, NOSAVE},
	{"var.name42", 's', &conf_var_name[42], OPTIONAL, NOSAVE},
	{"var.name43", 's', &conf_var_name[43], OPTIONAL, NOSAVE},
	{"var.name44", 's', &conf_var_name[44], OPTIONAL, NOSAVE},
	{"var.name45", 's', &conf_var_name[45], OPTIONAL, NOSAVE},
	{"var.name46", 's', &conf_var_name[46], OPTIONAL, NOSAVE},
	{"var.name47", 's', &conf_var_name[47], OPTIONAL, NOSAVE},
	{"var.name48", 's', &conf_var_name[48], OPTIONAL, NOSAVE},
	{"var.name49", 's', &conf_var_name[49], OPTIONAL, NOSAVE},
	{"var.name50", 's', &conf_var_name[50], OPTIONAL, NOSAVE},
	{"var.name51", 's', &conf_var_name[51], OPTIONAL, NOSAVE},
	{"var.name52", 's', &conf_var_name[52], OPTIONAL, NOSAVE},
	{"var.name53", 's', &conf_var_name[53], OPTIONAL, NOSAVE},
	{"var.name54", 's', &conf_var_name[54], OPTIONAL, NOSAVE},
	{"var.name55", 's', &conf_var_name[55], OPTIONAL, NOSAVE},
	{"var.name56", 's', &conf_var_name[56], OPTIONAL, NOSAVE},
	{"var.name57", 's', &conf_var_name[57], OPTIONAL, NOSAVE},
	{"var.name58", 's', &conf_var_name[58], OPTIONAL, NOSAVE},
	{"var.name59", 's', &conf_var_name[59], OPTIONAL, NOSAVE},
	{"var.name60", 's', &conf_var_name[60], OPTIONAL, NOSAVE},
	{"var.name61", 's', &conf_var_name[61], OPTIONAL, NOSAVE},
	{"var.name62", 's', &conf_var_name[62], OPTIONAL, NOSAVE},
	{"var.name63", 's', &conf_var_name[63], OPTIONAL, NOSAVE},
	{"var.name64", 's', &conf_var_name[64], OPTIONAL, NOSAVE},
	{"var.name65", 's', &conf_var_name[65], OPTIONAL, NOSAVE},
	{"var.name66", 's', &conf_var_name[66], OPTIONAL, NOSAVE},
	{"var.name67", 's', &conf_var_name[67], OPTIONAL, NOSAVE},
	{"var.name68", 's', &conf_var_name[68], OPTIONAL, NOSAVE},
	{"var.name69", 's', &conf_var_name[69], OPTIONAL, NOSAVE},
	{"var.name70", 's', &conf_var_name[70], OPTIONAL, NOSAVE},
	{"var.name71", 's', &conf_var_name[71], OPTIONAL, NOSAVE},
	{"var.name72", 's', &conf_var_name[72], OPTIONAL, NOSAVE},
	{"var.name73", 's', &conf_var_name[73], OPTIONAL, NOSAVE},
	{"var.name74", 's', &conf_var_name[74], OPTIONAL, NOSAVE},
	{"var.name75", 's', &conf_var_name[75], OPTIONAL, NOSAVE},
	{"var.name76", 's', &conf_var_name[76], OPTIONAL, NOSAVE},
	{"var.name77", 's', &conf_var_name[77], OPTIONAL, NOSAVE},
	{"var.name78", 's', &conf_var_name[78], OPTIONAL, NOSAVE},
	{"var.name79", 's', &conf_var_name[79], OPTIONAL, NOSAVE},
	{"var.name80", 's', &conf_var_name[80], OPTIONAL, NOSAVE},
	{"var.name81", 's', &conf_var_name[81], OPTIONAL, NOSAVE},
	{"var.name82", 's', &conf_var_name[82], OPTIONAL, NOSAVE},
	{"var.name83", 's', &conf_var_name[83], OPTIONAL, NOSAVE},
	{"var.name84", 's', &conf_var_name[84], OPTIONAL, NOSAVE},
	{"var.name85", 's', &conf_var_name[85], OPTIONAL, NOSAVE},
	{"var.name86", 's', &conf_var_name[86], OPTIONAL, NOSAVE},
	{"var.name87", 's', &conf_var_name[87], OPTIONAL, NOSAVE},
	{"var.name88", 's', &conf_var_name[88], OPTIONAL, NOSAVE},
	{"var.name89", 's', &conf_var_name[89], OPTIONAL, NOSAVE},
	{"var.name90", 's', &conf_var_name[90], OPTIONAL, NOSAVE},
	{"var.name91", 's', &conf_var_name[91], OPTIONAL, NOSAVE},
	{"var.name92", 's', &conf_var_name[92], OPTIONAL, NOSAVE},
	{"var.name93", 's', &conf_var_name[93], OPTIONAL, NOSAVE},
	{"var.name94", 's', &conf_var_name[94], OPTIONAL, NOSAVE},
	{"var.name95", 's', &conf_var_name[95], OPTIONAL, NOSAVE},
	{"var.name96", 's', &conf_var_name[96], OPTIONAL, NOSAVE},
	{"var.name97", 's', &conf_var_name[97], OPTIONAL, NOSAVE},
	{"var.name98", 's', &conf_var_name[98], OPTIONAL, NOSAVE},
	{"var.name99", 's', &conf_var_name[99], OPTIONAL, NOSAVE},
	{"var.name10000", 's', &conf_var_name[10000], OPTIONAL, SAVE},
	{"var.name10001", 's', &conf_var_name[10001], OPTIONAL, SAVE},
	{"var.name10002", 's', &conf_var_name[10002], OPTIONAL, SAVE},
	{"var.name10003", 's', &conf_var_name[10003], OPTIONAL, SAVE},
	{"var.name10004", 's', &conf_var_name[10004], OPTIONAL, SAVE},
	{"var.name10005", 's', &conf_var_name[10005], OPTIONAL, SAVE},
	{"var.name10006", 's', &conf_var_name[10006], OPTIONAL, SAVE},
	{"var.name10007", 's', &conf_var_name[10007], OPTIONAL, SAVE},
	{"var.name10008", 's', &conf_var_name[10008], OPTIONAL, SAVE},
	{"var.name10009", 's', &conf_var_name[10009], OPTIONAL, SAVE},
	{"var.name10010", 's', &conf_var_name[10010], OPTIONAL, NOSAVE},
	{"var.name10011", 's', &conf_var_name[10011], OPTIONAL, NOSAVE},
	{"var.name10012", 's', &conf_var_name[10012], OPTIONAL, NOSAVE},
	{"var.name10013", 's', &conf_var_name[10013], OPTIONAL, NOSAVE},
	{"var.name10014", 's', &conf_var_name[10014], OPTIONAL, NOSAVE},
	{"var.name10015", 's', &conf_var_name[10015], OPTIONAL, NOSAVE},
	{"var.name10016", 's', &conf_var_name[10016], OPTIONAL, NOSAVE},
	{"var.name10017", 's', &conf_var_name[10017], OPTIONAL, NOSAVE},
	{"var.name10018", 's', &conf_var_name[10018], OPTIONAL, NOSAVE},
	{"var.name10019", 's', &conf_var_name[10019], OPTIONAL, NOSAVE},
	{"var.name10020", 's', &conf_var_name[10020], OPTIONAL, NOSAVE},
	{"var.name10021", 's', &conf_var_name[10021], OPTIONAL, NOSAVE},
	{"var.name10022", 's', &conf_var_name[10022], OPTIONAL, NOSAVE},
	{"var.name10023", 's', &conf_var_name[10023], OPTIONAL, NOSAVE},
	{"var.name10024", 's', &conf_var_name[10024], OPTIONAL, NOSAVE},
	{"var.name10025", 's', &conf_var_name[10025], OPTIONAL, NOSAVE},
	{"var.name10026", 's', &conf_var_name[10026], OPTIONAL, NOSAVE},
	{"var.name10027", 's', &conf_var_name[10027], OPTIONAL, NOSAVE},
	{"var.name10028", 's', &conf_var_name[10028], OPTIONAL, NOSAVE},
	{"var.name10029", 's', &conf_var_name[10029], OPTIONAL, NOSAVE},
	{"var.name10030", 's', &conf_var_name[10030], OPTIONAL, NOSAVE},
	{"var.name10031", 's', &conf_var_name[10031], OPTIONAL, NOSAVE},
	{"var.name10032", 's', &conf_var_name[10032], OPTIONAL, NOSAVE},
	{"var.name10033", 's', &conf_var_name[10033], OPTIONAL, NOSAVE},
	{"var.name10034", 's', &conf_var_name[10034], OPTIONAL, NOSAVE},
	{"var.name10035", 's', &conf_var_name[10035], OPTIONAL, NOSAVE},
	{"var.name10036", 's', &conf_var_name[10036], OPTIONAL, NOSAVE},
	{"var.name10037", 's', &conf_var_name[10037], OPTIONAL, NOSAVE},
	{"var.name10038", 's', &conf_var_name[10038], OPTIONAL, NOSAVE},
	{"var.name10039", 's', &conf_var_name[10039], OPTIONAL, NOSAVE},
	{"var.name10040", 's', &conf_var_name[10040], OPTIONAL, NOSAVE},
	{"var.name10041", 's', &conf_var_name[10041], OPTIONAL, NOSAVE},
	{"var.name10042", 's', &conf_var_name[10042], OPTIONAL, NOSAVE},
	{"var.name10043", 's', &conf_var_name[10043], OPTIONAL, NOSAVE},
	{"var.name10044", 's', &conf_var_name[10044], OPTIONAL, NOSAVE},
	{"var.name10045", 's', &conf_var_name[10045], OPTIONAL, NOSAVE},
	{"var.name10046", 's', &conf_var_name[10046], OPTIONAL, NOSAVE},
	{"var.name10047", 's', &conf_var_name[10047], OPTIONAL, NOSAVE},
	{"var.name10048", 's', &conf_var_name[10048], OPTIONAL, NOSAVE},
	{"var.name10049", 's', &conf_var_name[10049], OPTIONAL, NOSAVE},
	{"var.name10050", 's', &conf_var_name[10050], OPTIONAL, NOSAVE},
	{"var.name10051", 's', &conf_var_name[10051], OPTIONAL, NOSAVE},
	{"var.name10052", 's', &conf_var_name[10052], OPTIONAL, NOSAVE},
	{"var.name10053", 's', &conf_var_name[10053], OPTIONAL, NOSAVE},
	{"var.name10054", 's', &conf_var_name[10054], OPTIONAL, NOSAVE},
	{"var.name10055", 's', &conf_var_name[10055], OPTIONAL, NOSAVE},
	{"var.name10056", 's', &conf_var_name[10056], OPTIONAL, NOSAVE},
	{"var.name10057", 's', &conf_var_name[10057], OPTIONAL, NOSAVE},
	{"var.name10058", 's', &conf_var_name[10058], OPTIONAL, NOSAVE},
	{"var.name10059", 's', &conf_var_name[10059], OPTIONAL, NOSAVE},
	{"var.name10060", 's', &conf_var_name[10060], OPTIONAL, NOSAVE},
	{"var.name10061", 's', &conf_var_name[10061], OPTIONAL, NOSAVE},
	{"var.name10062", 's', &conf_var_name[10062], OPTIONAL, NOSAVE},
	{"var.name10063", 's', &conf_var_name[10063], OPTIONAL, NOSAVE},
	{"var.name10064", 's', &conf_var_name[10064], OPTIONAL, NOSAVE},
	{"var.name10065", 's', &conf_var_name[10065], OPTIONAL, NOSAVE},
	{"var.name10066", 's', &conf_var_name[10066], OPTIONAL, NOSAVE},
	{"var.name10067", 's', &conf_var_name[10067], OPTIONAL, NOSAVE},
	{"var.name10068", 's', &conf_var_name[10068], OPTIONAL, NOSAVE},
	{"var.name10069", 's', &conf_var_name[10069], OPTIONAL, NOSAVE},
	{"var.name10070", 's', &conf_var_name[10070], OPTIONAL, NOSAVE},
	{"var.name10071", 's', &conf_var_name[10071], OPTIONAL, NOSAVE},
	{"var.name10072", 's', &conf_var_name[10072], OPTIONAL, NOSAVE},
	{"var.name10073", 's', &conf_var_name[10073], OPTIONAL, NOSAVE},
	{"var.name10074", 's', &conf_var_name[10074], OPTIONAL, NOSAVE},
	{"var.name10075", 's', &conf_var_name[10075], OPTIONAL, NOSAVE},
	{"var.name10076", 's', &conf_var_name[10076], OPTIONAL, NOSAVE},
	{"var.name10077", 's', &conf_var_name[10077], OPTIONAL, NOSAVE},
	{"var.name10078", 's', &conf_var_name[10078], OPTIONAL, NOSAVE},
	{"var.name10079", 's', &conf_var_name[10079], OPTIONAL, NOSAVE},
	{"var.name10080", 's', &conf_var_name[10080], OPTIONAL, NOSAVE},
	{"var.name10081", 's', &conf_var_name[10081], OPTIONAL, NOSAVE},
	{"var.name10082", 's', &conf_var_name[10082], OPTIONAL, NOSAVE},
	{"var.name10083", 's', &conf_var_name[10083], OPTIONAL, NOSAVE},
	{"var.name10084", 's', &conf_var_name[10084], OPTIONAL, NOSAVE},
	{"var.name10085", 's', &conf_var_name[10085], OPTIONAL, NOSAVE},
	{"var.name10086", 's', &conf_var_name[10086], OPTIONAL, NOSAVE},
	{"var.name10087", 's', &conf_var_name[10087], OPTIONAL, NOSAVE},
	{"var.name10088", 's', &conf_var_name[10088], OPTIONAL, NOSAVE},
	{"var.name10089", 's', &conf_var_name[10089], OPTIONAL, NOSAVE},
	{"var.name10090", 's', &conf_var_name[10090], OPTIONAL, NOSAVE},
	{"var.name10091", 's', &conf_var_name[10091], OPTIONAL, NOSAVE},
	{"var.name10092", 's', &conf_var_name[10092], OPTIONAL, NOSAVE},
	{"var.name10093", 's', &conf_var_name[10093], OPTIONAL, NOSAVE},
	{"var.name10094", 's', &conf_var_name[10094], OPTIONAL, NOSAVE},
	{"var.name10095", 's', &conf_var_name[10095], OPTIONAL, NOSAVE},
	{"var.name10096", 's', &conf_var_name[10096], OPTIONAL, NOSAVE},
