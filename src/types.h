 ...
 *  - POLARIS_TARGET_WIN32   for Win32 (x86/x64/Arm64)
 *  - POLARIS_TARGET_MACOS   for macOS (Arm64/x86_64)
 *  - POLARIS_TARGET_IOS     for iOS (Arm64)
 *  - POLARIS_TARGET_ANDROID for Android (armv8/armv7/x86_64)
 *  - POLARIS_TARGET_WASM    for Wasm with Emscripten
 *  - POLARIS_TARGET_POSIX   for Linux and *BSD
 *  - POLARIS_TARGET_SDL2    for SDL2
 */
#if defined(__APPLE__)
#include <TargetConditionals.h>
#if TARGET_OS_IPHONE
#define POLARIS_TARGET_IOS
#else
#define POLARIS_TARGET_MACOS
#endif
#elif defined(_WIN32)
#define POLARIS_TARGET_WIN32
 ...
 */
  ...
  *  - POLARIS_ARCH_X86 for ia32 (x86)
  *  - POLARIS_ARCH_X86_64 for amd64 (x86_64)
  *  - POLARIS_ARCH_ARM32 for armv7
  *  - POLARIS_ARCH_ARM64 for armv8
  */
#if defined(__i386__) && !defined(__x86_64__)
#define POLARIS_ARCH_X86
#elif defined(__x86_64__)
#define POLARIS_ARCH_X86_64
#elif defined(__arm__)
#define POLARIS_ARCH_ARM32
#elif defined(__aarch64__)
#define POLARIS_ARCH_ARM64
#endif
